Feature: Roomtype page
    ...
    Scenario: TC_002: Validate whether the user is able to check on the include food checkbox
        Given : User launches the view details page
        When : The user clicks on the include food checkbox
        Then : The user should be able to check the include food checkbox
